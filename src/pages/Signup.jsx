  ...
  return (
    <HomeLayout>
        <div className="flex overflow-x-auto items-center justify-center h-[100vh]">
            <form onSubmit={onFormSubmit} noValidate className=" flex flex-col justify-center gap-6 rounded-lg p-4 text-white w-35">
                ...
                <label htmlFor="fullName" className="font-semibold text-lg">Name</label>
                <input 
